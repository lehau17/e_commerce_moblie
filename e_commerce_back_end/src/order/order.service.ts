...
export class OrderService {
  ...
  async create({ address_id, payment_method_id }: CreateOrderDto, userId: number) {
    ...
    if (!payment_method_id) throw new BadRequestException('Phương thức thanh toán không tồn tại')
    ...
    if (!newOrder) throw new BadRequestException("Có lỗi xảy ra. Vui lòng thử lại")
